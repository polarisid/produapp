	...
	return (
		<>
			...
			<Container padding="40px 70px 0px 70px">
				<Flex>
					...
					<Form2 onSubmit={handleShortenButtonClick}>
						...
						<SelectedStyled
							...
							required
						/>
						<Button type="submit" maxWidth="182px">
							Adicionar
						</Button>
					</Form2>
				</Flex>
				...
				<footer>
					Powered by Daniel - Este site foi descontinuado - vem ai ProduApp 2 -
					11/06/2022{" "}
				</footer>
			</Container>
		</>
			...
			{urls.map((url) => (
				<Url key={url.id}>
					...
					>
						...
						<UrlLink color="#FFF" fontWeight="400">
							{myOptions[url.typeId - 1].label}
						</UrlLink>
						<UrlLink color="#FFF" fontWeight="400">
							{" "}
							Horário: {dayjs(url.datetime).format("HH:mm")}
						</UrlLink>
						<UrlLink color="#FFF" fontWeight="400">
							{" "}
							Data: {dayjs(url.datetime).format("DD/MM")}
						</UrlLink>
					</Flex>
